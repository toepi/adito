...
public class NetworkPlaceVFSResource extends FileObjectVFSResource {
    ...
    /* (non-Javadoc)
     * @see com.adito.vfs.FileObjectVFSResource#getChildren()
     */
	...
	/* (non-Javadoc)
	 * @see com.adito.vfs.FileObjectVFSResource#getDisplayName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.adito.vfs.FileObjectVFSResource#isMount()
	 */
