...
/**
 * Implementations of this interface provide the root of a single configured
 * <i>Mount</i> to some file system specific file system. <p> The mount is
 * responsible for creating {@link com.adito.vfs.VFSResource} objects suitable
 * for the file system.
 */
public interface VFSMount {
    ...
    /**
     * Get a resource given its path relative to this mount. To get the root
     * resource supply an empty string as the path.
     *
    ...
    /**
     * Return the pathname for this mount. It must have a trailing slash (/) and
     * be encoded.
     *
     * @return mount string
     */
    ...
    /**
     * Invoked when a collection resource is listed from this mount. If the
     * access failed then a non-null exception will provided
     *
     * @param resource resource
     * @param transaction transaction
     * @param exception any error or <code>null</code> if succesful
